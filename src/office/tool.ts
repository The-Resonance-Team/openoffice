  ...
  return {
    ...
    parameters: z.object({
      ...
      file: z
        .string()
        .optional()
        .describe("Path to the document (merge uses template instead)"),
      path: z
        .string()
        .optional()
      ...
      parent: z
        .string()
        .optional()
        .describe("Parent DOM path (add/import target)"),
      type: z
        .string()
        .optional()
        .describe(
          "Element type to add (e.g., paragraph, run, table, slide, shape)"
        ),
      props: z
      ...
      find: z
        .string()
        .optional()
        .describe("Find this text/pattern to replace (set)"),
      replace: z
        .string()
        .optional()
        .describe("Replacement text for --find matches (set)"),
      from: z
        .string()
        .optional()
        .describe("Copy from an existing element path (add)"),
      to: z.string().optional().describe("Target parent path (move)"),
      index: z
        .string()
        .optional()
        .describe("Insert position, 0-based (add/move)"),
      after: z
        .string()
        .optional()
        .describe("Insert/move after the element at this path"),
      before: z
        .string()
        .optional()
        .describe("Insert/move before the element at this path"),
      operations: z
        .array(z.any())
        .optional()
      ...
      part: z
        .string()
        .optional()
        .describe("Document part path (raw/raw-set, e.g., /document)"),
      xpath: z
        .string()
        .optional()
        .describe("XPath to target elements (raw-set)"),
      action: z
        .enum([
          "append",
          "prepend",
      ...
      xml: z
        .string()
        .optional()
        .describe("XML fragment or attr=value (raw-set)"),
      source: z
        .string()
        .optional()
        .describe("Source CSV/TSV file to import (import)"),
      template: z
        .string()
        .optional()
        .describe("Template file with {{key}} placeholders (merge)"),
      output: z.string().optional().describe("Output file path (merge)"),
      data: z
        .string()
        .optional()
        .describe("JSON data or path to .json file (merge)"),
      format: z
        .string()
        .optional()
        .describe("Format for help (docx, xlsx, pptx)"),
