...
A working openoffice desktop app where non-technical users chat with an agent to create/edit Word/Excel/PowerPoint documents, with auto-approve behind Edit Preview, Version History, and managed sign-in — built from scratch.
...
- Cloud infrastructure (local-first for v1)
- Enterprise features
