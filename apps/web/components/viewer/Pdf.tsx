    ...
    <div className="flex flex-col items-center gap-5 py-6 font-serif text-[#1b1b1b]">
      <div className="min-h-[780px] w-[580px] max-w-[92%] rounded-md bg-white p-[50px_56px] shadow-xl">
        ...
        <p className="mb-3 text-justify text-[13.5px] leading-[1.75]">
          This benchmark aggregates operating metrics from 480 private B2B
          software companies with $10M–$100M in annual recurring revenue.
          Figures reflect data reported through 30 September 2026 and are
          presented as percentile bands to preserve confidentiality.
        </p>
        ...
        <p className="text-justify text-[13.5px] leading-[1.75]">
          Companies sustaining net revenue retention above 115% clustered in the
          top growth quartile regardless of size band, reinforcing expansion
          revenue as the dominant efficient-growth lever this cycle.
        </p>
      </div>
    </div>
  );
