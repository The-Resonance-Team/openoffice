...
describe('write tool', () => {
  test('writes text files', async () => {
    ...
    const result = await tool.execute({ file, content: 'hello' }, { sessionID: 'test' });
    expect(result.success).toBe(true);
...
describe('glob tool', () => {
  test('finds files by pattern', async () => {
    ...
    const result = await tool.execute({ pattern: '**/*.ts', path: dir }, { sessionID: 'test' });
    expect(result.success).toBe(true);
    if (result.success) {
...
describe('grep tool', () => {
  test('returns matching lines', async () => {
    ...
    const result = await tool.execute({ query: 'alpha', path: file }, { sessionID: 'test' });
    expect(result.success).toBe(true);
    if (result.success) {
  ...
  test('reports no matches without failing', async () => {
    ...
    const tool = createGrepTool();
    const result = await tool.execute({ query: 'zzz', path: file }, { sessionID: 'test' });
    expect(result.success).toBe(true);
  ...
  test('searches filenames and paths', async () => {
    ...
    const result = await tool.execute({ query: 'report', path: dir }, { sessionID: 'test' });
  ...
  test('searches document metadata', async () => {
    ...
    const result = await tool.execute({ query: 'quarterly', path: dir }, { sessionID: 'test' });
  ...
  test('searches PDF annotations and Excel formulas/comments', async () => {
    ...
    const pdfResult = await tool.execute({ query: 'Appendix', path: dir }, { sessionID: 'test' });
    const xlsxResult = await tool.execute({ query: 'budget', path: dir }, { sessionID: 'test' });
  ...
  test('does not search system metadata fields', async () => {
    ...
    const result = await tool.execute({ query: 'hidden', path: dir }, { sessionID: 'test' });
  ...
  test('resolves document drafts before extraction', async () => {
    ...
    const result = await tool.execute({ query: 'target', path: realPath }, { sessionID: 'test' });
  ...
  test('handles complex regex safely for extracted documents', async () => {
    ...
    const result = await tool.execute({ query: '(a+)+$', path: dir }, { sessionID: 'test' });
...
describe('question tool', () => {
  test('returns user answer', async () => {
    ...
    const result = await tool.execute({ question: 'What is 2+2?' }, { sessionID: 'test' });
    expect(result.success).toBe(true);
  ...
  test('returns error when ask fails', async () => {
    ...
    const result = await tool.execute({ question: 'Still there?' }, { sessionID: 'test' });
    expect(result.success).toBe(false);
    if (!result.success) {
