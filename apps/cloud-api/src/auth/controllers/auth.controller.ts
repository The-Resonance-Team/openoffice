...
import type { OAuthProfile } from "../services";
import {
...
import type { ForgotPasswordDto } from "../dto";
import type { LoginDto } from "../dto";
import type { RegisterDto } from "../dto";
import type { ResendVerificationDto } from "../dto";
import type { ResetPasswordDto } from "../dto";
import type { SwitchOrgDto } from "../dto";
import type { VerifyEmailDto } from "../dto";
...
export class AuthController {
  ...
  async switchOrg(
    ...
    const result = await this.auth.switchOrg(
      dto,
      user.memberId,
      refresh ?? "",
      ipOf(req)
