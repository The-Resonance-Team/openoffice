...
import { createOfficeCliTool, isMutating, parseError, type OfficeCliDeps } from './tool';
...
export function createDefaultOfficeCliTool(extraDeps: Partial<OfficeCliDeps> = {}) {
